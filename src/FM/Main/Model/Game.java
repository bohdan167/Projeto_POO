...
public class Game {
    ...
    public Game (String ec, String ef, int gc, int gf, LocalDate d,  List<Integer> jc, Map<Integer, Integer> sc,  List<Integer> jf, Map<Integer, Integer> sf){
        equipaCasa = ec;
        equipaFora = ef;
        golosCasa = gc;
        golosFora = gf;
    ...
    public static Game parse(String input){
        ...
        return new Game(campos[0], campos[1], Integer.parseInt(campos[2]), Integer.parseInt(campos[3]),
